...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute shadow-lg shadow-[#004] left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#5B39CF] rounded-r-[2rem]  duration-300 ease-linear dark:bg-[#5B39CF] lg:static lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
              ...
              <li>
                ...
                >
                  <svg fill="#ffffff" height="20px" width="20px" version="1.1" id="Layer_1"
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 475.851 475.851"
