...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute shadow-lg shadow-[#004] left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#5B39CF] rounded-r-[2rem]  duration-300 ease-linear dark:bg-[#5B39CF] lg:static lg:translate-x-0 drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none ${
                      ...
                      <g>
                        ...
                        <g>
                          ...
                          <g>
                            ...
                            <path d="M69.854,351.003c-2.671,6.443,4.532,12.832,10.617,9.387c3.238-1.834,4.683-5.937,3.227-9.385 C81.291,344.86,72.32,345.053,69.854,351.003z"></path>{" "}
                            <path d="M83.698,351.005C83.888,351.455,83.518,350.545,83.698,351.005L83.698,351.005z"></path>{" "}
