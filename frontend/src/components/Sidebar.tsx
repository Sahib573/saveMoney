          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/ecommerce"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#8D80EE] dark:hover:bg-meta-4 ${(pathname === "/" || pathname.includes("dashboard")) &&
                    "dark:bg-meta-4"
                    }`}
                // onClick={(e) => {
                //   e.preventDefault();
              ...
              <li>
                <NavLink
                  to="/transaction"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#8D80EE] dark:hover:bg-meta-4 ${pathname.includes("calendar") && "dark:bg-meta-4"
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#8D80EE] dark:hover:bg-meta-4 ${pathname.includes("profile") && "dark:bg-meta-4"
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/groups"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#8D80EE] dark:hover:bg-meta-4 ${pathname.includes("friends") && "dark:bg-meta-4"
                    }`}
                >
              ...
              <li>
                <NavLink
                  to="/analytics"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#8D80EE] dark:hover:bg-meta-4 ${pathname.includes("tables") && "dark:bg-meta-4"
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/settings"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#8D80EE] dark:hover:bg-meta-4 ${pathname.includes("settings") && "dark:bg-meta-4"
                    }`}
                >
                  <svg
                    className="fill-current"
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-6">
              ...
              <li>
                <NavLink
                  to="/aboutUs"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-[#8D80EE] dark:hover:bg-meta-4 ${pathname.includes("chart") && "dark:bg-meta-4"
                    }`}
                >
                  <svg
                    className="fill-current"
